...
const MASTER_CHEF_ADDRESS = '0xf712a82DD8e2Ac923299193e9d6dAEda2d5a32fd'
...
export const gettBaoSupply = async (bao: Bao): Promise<BigNumber> => {
  const tBaoStakingContract = gettBaoStakingContract(bao)
  return new BigNumber(await tBaoStakingContract.methods.totalSupply().call())
}
